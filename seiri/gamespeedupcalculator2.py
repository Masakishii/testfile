...
class MainWindow(QWidget):
    ...
    def SetLabel(self):
        ...
        label_day.setStyleSheet(labelStyle1)
        label_day.setText("入力日")   
        label_day.move(200, 20)
...
#テキストボックス
    def SetLineedit(self):
        ...
        self.free_day = QLineEdit(self) 
        self.free_day.move(300, 25) 
        self.free_day.resize(150, 25)  
...
#プッシュボタン
    ...
    def CallbackButtonPressed(self):
        info_day = str(self.self.free_day.text())

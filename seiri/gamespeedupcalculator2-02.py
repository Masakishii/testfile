...
#プッシュボタン
    ...
    def CallbackButtonPressed(self):
        ...
        Fre_01ms_str = str('{:11,d}'.format(Fre_01ms))
        Fre_05ms_str = str('{:11,d}'.format(Fre_05ms))
        Fre_10ms_str = str('{:11,d}'.format(Fre_10ms))
        Fre_15ms_str = str('{:11,d}'.format(Fre_15ms))
        Fre_30ms_str = str('{:11,d}'.format(Fre_30ms))
        Fre_60ms_str = str('{:11,d}'.format(Fre_60ms))
        Fre_03hs_str = str('{:11,d}'.format(Fre_03hs))
        Fre_08hs_str = str('{:11,d}'.format(Fre_08hs))
        Fre_15hs_str = str('{:11,d}'.format(Fre_15hs))
        Fre_24hs_str = str('{:11,d}'.format(Fre_24hs))
        Fre_72hs_str = str('{:11,d}'.format(Fre_72hs))
